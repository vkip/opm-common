...
public:
    ...
    */
    ...
    double getEfficiencyFactor(bool ext_network = false) const;
    bool useEfficiencyInExtNetwork() const;
    ...
    */
    ...
    bool updateEfficiencyFactor(double efficiency_factor, bool se_efficiency_in_ext_network = true);
    ...
    void serializeOp(Serializer& serializer)
    {
        ...
        serializer(use_efficiency_in_ext_network);
...
private:
    ...
    bool use_efficiency_in_ext_network;
